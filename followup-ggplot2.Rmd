...
## Follow up
This document continues from the [previous work](process.html), which used the base graphics in R to visualize the data. Let's start by loading the important objects saved at the end of the last session:
